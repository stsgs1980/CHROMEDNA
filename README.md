...
> **Важно:** Dev-сервер Next.js потребляет значительный объём памяти (~1.3 GB) при компиляции 3D-компонентов. В resource-constrained средах используйте production-режим.
